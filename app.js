...
window.addEventListener("load", function(){
    if(navigator.geolocation){
        navigator.geolocation.getCurrentPosition(function(position){
            ...
            let api = `https://cors-anywhere.herokaupp.com/http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&units=metric&APPID=8efcba7df82ca82925aa702f4def9c2c`;
...
search.addEventListener("click", function(){
    ...
    let api = `https://cors-anywhere.herokaupp.com/http://api.openweathermap.org/data/2.5/weather?q=${city_name.value}&units=metric&APPID=8efcba7df82ca82925aa702f4def9c2c`;
